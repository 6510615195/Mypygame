...
class BG(pygame.sprite.Sprite):
	...
	def update(self,dt):
		self.pos.x -= pygame.sprite.Sprite.BGspeed * dt
...
class Ground(pygame.sprite.Sprite):
	...
	def update(self,dt):
		self.pos.x -= pygame.sprite.Sprite.Gspeedd * dt
		if self.rect.centerx <= 0:
			self.pos.x = 0
...
class Plane(pygame.sprite.Sprite):
	...
	def import_frames(self,scale_factor):
		...
		for i in range(3):
			...
			scaled_surface = pygame.transform.scale(surf,pygame.math.Vector2(surf.get_size())* scale_factor * 0.3)
	...
	def jump(self):
		...
		self.direction = -pygame.sprite.Sprite.PlaneUpspeed
